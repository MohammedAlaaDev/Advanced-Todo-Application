...
import type { taskDetailsObject, TaskError } from "@/features/tasks/types";
import { taskDetailsSchema } from "@/features/tasks/schemas/taskDetailsSchema";
...
const TaskDetailsForm = forwardRef<TaskDetailsRefType, {}>((_, ref) => {
    ...
    const handleStepOne = (e?: PreventableEvent) => {
        e?.preventDefault();
        ...
        data.categories = data.categories.filter((cat) => cat !== "");
